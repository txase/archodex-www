...
To create a Report API Key, navigate to the _Account Settings_ section in the Archodex Dashboard for your self-hosted
account (if you're not already there). Click on the _Create New API Key_ button. Give your API key a name and click
_Create_. Make sure to copy the generated API key, as you will need it in the next step.
